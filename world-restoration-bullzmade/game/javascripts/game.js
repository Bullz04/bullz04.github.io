...
let temp = {
    ...
    automator : {
        ...
        autoRNEUs : {
            requirement : function() { return player.karma.gte(3) }
        },
        autoNNEUs : {
            requirement : function() { return player.karma.gte(10) }
        },
        autoNewEpisodes : {
    ...
    karmaUpgrades : {
        nonRepeatable : {
            ...
            cost : [
                ...
                new Decimal("1e422"), new Decimal("1e600"), new Decimal("1e1125"), new Decimal("1e1165")
...
function updateText() {
    ...
    document.getElementById("AutomatorReq2").innerHTML = format(3, 3, 0)
    document.getElementById("AutomatorReq3").innerHTML = format(10, 3, 0)
