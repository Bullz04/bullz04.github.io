class Player {
    constructor() {
        ...
        this.achievementsGotten = [
            ...
            false,false,false,false,false,false,false,//49
...
let temp = {
    unlockCondition : {
        ...
        theJudgement : function() { return player.karma.gte(1e80) || player.justicePoints.gt(0) }
    },

    automator : {
        autoFRs : {//1
            requirement : function() { return player.keys.gte(1000) }
        },
        autoRNEUs : {
            requirement : function() { return player.cakes.gte(3000) }
        },
        autoNNEUs : {
            requirement : function() { return player.cakes.gte(10000) }
        },
        autoRCUs : {
            requirement : function() { return player.karma.gte(50) }
        },
        autoNCUs : {
            requirement : function() { return player.karma.gte(2000) }
        },
        autoPreExt : {
            requirement : function() { return player.karma.gte("1e500") }
        }
    },
    ...
    prestigeRequirements : {
        resource : [
            "player.repelledForks", "player.keys", "player.cakes"
        ],
        amountRequired : [
            new Decimal(1e3), new Decimal(1e10), new Decimal(1e20)
        ]
    },
    ...
    NEUpgrades : {
        nonRepeatable : {
            ...
            cost : [
                new Decimal(10), new Decimal(25), new Decimal(150), new Decimal(1e90),
                new Decimal(1e300), new Decimal("1e900"), new Decimal("1e1400"), new Decimal("1e3000")
            ]
        },
        repeatable : {
            costFormula : [
                function() {//keys boost its gain
                    return Decimal.pow(
                        ...
                        Decimal.pow(
                            1.5,
                            player.NEUpgrades.repeatable.levels[0].div(1.5).div(getRNEUScalingWeakness(0))
                            .plus(2.85)
                        )
                    )
                ...
                function() {//forks boost keys
                    ...
                    .times(1e5).div(getRNEUDiscounts(2))
                }
            ],
            levelGain : [
                function() {
                    return Decimal.log(
                        ...
                        1.5
                    ).minus(2.85).times(1.5).times(getRNEUScalingWeakness(0))
                    .floor()
                },
                ...
                function() {
                    return Decimal.log(
                        player.keys.div(1e5).times(getRNEUDiscounts(2)),
                        10
    ...
    cakeUpgrades : {
        nonRepeatable : {
            ...
            cost : [
                ...
                new Decimal(3e9), new Decimal(1e10), new Decimal(1e14), new Decimal(1e19)
            ]
        },
        repeatable : {
            costFormula : [
                function() {
                    return Decimal.pow(
                        10,
                        player.cakeUpgrades.repeatable.levels[0].div(300).div(getRCUScalingWeaknesses(0)).plus(1.05)
                        .pow(3)
                    )
                ...
                function() {
                    return Decimal.pow(
                        ...
                        Decimal.pow(
                            1.5,
                            player.cakeUpgrades.repeatable.levels[1].div(6).div(getRCUScalingWeaknesses(1)).plus(1.5)
                        )
                    )
                ...
                function() {
                    return Decimal.pow(
                        ...
                        Decimal.pow(
                            2,
                            player.cakeUpgrades.repeatable.levels[2].div(2).div(getRCUScalingWeaknesses(2)).plus(1.6)
                        )
                    )
            ...
            levelGain : [
                function() {
                    return Decimal.log(
                        ...
                        10
                    ).pow(1/3).minus(1.05).times(300).times(getRCUScalingWeaknesses(0))
                    .floor()
                },
                ...
                function() {
                    return Decimal.log(
                        ...
                        1.5
                    ).minus(1.5).times(6).times(getRCUScalingWeaknesses(1))
                    .floor()
                },
                ...
                function() {
                    return Decimal.log(
                        ...
                        2
                    ).minus(1.6).times(2).times(getRCUScalingWeaknesses(2))
                    .floor()
                },
                ...
                function() {
                    return Decimal.log(
                        Decimal.log(
                            player.cakes.times(getRCUDiscounts(3)).times(100),
                            10
                        ),
                        1.5
    ...
    karmaUpgrades : {
        nonRepeatable : {
            ...
            cost : [
                new Decimal(10), new Decimal(15), new Decimal(200), new Decimal(500),
                new Decimal(1e7), new Decimal(1e10), new Decimal(1e25), new Decimal(1e46),
                new Decimal(1e56), new Decimal(1e60), new Decimal(1e87), new Decimal(1e96),
                new Decimal(5e98), new Decimal(1e110), new Decimal(3e143), new Decimal(1e198),
                new Decimal("1.2e302"), new Decimal("1e340"), new Decimal("1e362"), new Decimal("1e414"),
                new Decimal("1e613"), new Decimal("1e795"), new Decimal("4e910"), new Decimal("1.111e1162"),
                new Decimal("1e1262"), new Decimal("1e1500"), new Decimal("1e1522"), new Decimal("2e1841")
        ...
        repeatable : {
            costFormula : [
                ...
                function() {
                    ...
                    .div(2e6).div(getRKaUDiscounts(1))
                },
                ...
                function() {
                    return Decimal.pow(
                        ...
                        Decimal.pow(
                            1.075,
                            player.karmaUpgrades.repeatable.levels[2].div(3).div(getRKaUScalingWeaknesses(2)).plus(16)
                            .pow(1.3)
                        )
                    )
                    .div(4e6).div(getRKaUDiscounts(2))
                },
                ...
                function() {
                    return Decimal.pow(
                        ...
                        Decimal.pow(
                            1.2,
                            player.karmaUpgrades.repeatable.levels[3].div(1.1).div(getRKaUScalingWeaknesses(3)).plus(5)
                        )
                    )
                    .times(4).div(getRKaUDiscounts(3))
                }
            ],
            levelGain : [
                function() {
                    return Decimal.log(
                        player.karma.times(getRKaUDiscounts(0)),
                        10
                ...
                function() {
                    return Decimal.log(
                        Decimal.log(
                            player.karma.times(2e6).times(getRKaUDiscounts(1)),
                            10
                        ),
                        1.075
                ...
                function() {
                    return Decimal.log(
                        Decimal.log(
                            player.karma.times(4e6).times(getRKaUDiscounts(2)),
                            4
                        ),
                        1.075
                    ).pow(1/1.3).minus(16).times(3).times(getRKaUScalingWeaknesses(2))
                    .floor()
                },
                ...
                function() {
                    return Decimal.log(
                        Decimal.log(
                            player.karma.div(4).times(getRKaUDiscounts(3)),
                            10
                        ),
                        1.2
                    ).minus(5).times(1.1).times(getRKaUScalingWeaknesses(3))
                    .floor()
                },
            ],
        }
    ...
    preciousEffect : {
        unlockCondition : [
            ...
            new Decimal(30), new Decimal(40), new Decimal(125), new Decimal(160),
            new Decimal(212), new Decimal(350)
        ],
        isUnlocked : [
            false, false, false, false,
            false, false, false, false,
...
function initStarterPack() {
    player.prestigeStat[0] = new Decimal(200)
    player.prestigeStat[1] = new Decimal(2)
    player.keys = new Decimal(20)
    player.gainedKeys = new Decimal(20)
}

function ExpPower(number, logBase, power) {
    number = new Decimal(number)
    logBase = new Decimal(logBase)
    power = new Decimal(power)
    if (power.gte(1)) {
        return Decimal.pow(
            logBase, Decimal.log(Decimal.abs(number).max(1), logBase).pow(power)
        ).times( (number.lt(0)) ? -1 : 1 )
    } else if (power.lt(1)) {
        return Decimal.pow(
            logBase, Decimal.log(Decimal.abs(number).max(1), logBase).root(power.pow(-1))
        ).times( (number.lt(0)) ? -1 : 1 )
    }
}

function getCheckboxStatement(x) {
    if (x == true) return "✔"
    else return "✘"
}
...
function getForkBoosts() {
    ...
    .times( (player.achievementsGotten[9]) ? getAchRewards("10") : new Decimal(1) )
    .times( (player.achievementsGotten[13]) ? getAchRewards("14") : new Decimal(1) )
    .times(getAchievementMultiplier())
    .times(getRNEUpgradeEffect("2"))
    ...
    .times( (player.cakeUpgrades.nonRepeatable.isBought[5]) ? getNCUpgradeEffect("6-Forks") : new Decimal(1) )
    ...
    .times( (temp.preciousEffect.isUnlocked[12]) ? getPFEffects("13") : new Decimal(1) )
...
function updateText() {
    ...
    document.getElementById("PFEffectBoost13").innerHTML = format(getPFEffects("13"), 3, 3)
    document.getElementById("PFEffectBoost14").innerHTML = format(getPFEffects("14"), 3, 3)
    ...
    for (let i = 0; i < 12; i++) {
        document.getElementById("ForksRequired" + (i + 1)).innerHTML = format(Decimal.pow(1.5, player.forkRepellentAmounts[i].minus( (i == 0) ? 1 : 0 )).times(10).times(Decimal.pow(1.7, i)), 3, 0);
        document.getElementById("FRAmount" + (i + 1)).innerHTML = format(player.forkRepellentAmounts[i], 3, 0)
        if (i == 0) {
            document.getElementById("FRProduction" + (i + 1)).innerHTML = format(
...
/*
    document.getElementById("ForksRequired" + (0 + 1)).innerHTML = format(
        Decimal.pow(1.5, player.forkRepellentAmounts[0].minus( (0 == 0) ? 1 : 0 ))
        .times(10)
        .times(Decimal.pow(1.7, 0))
    , 3, 0);
    document.getElementById("FRDetails" + (0 + 1)).innerHTML = `<br>
        Amount: ${format(player.forkRepellentAmounts[0], 3, 0)}<br>
        Base prod: <span style="font-size: 13px;">+${format(
            Decimal.pow(1.1, player.forkRepellentAmounts[0])
            .div( (0 == 0) ? 1.1 : 1 )
            .times(player.forkRepellentAmounts[0])
            .times(getForkBoosts())
        , 3, 2)}<img src="images/fork.png" alt="Fork Image" width="15" height="15">/s</span>
    `;

    document.getElementById("ForksRequired" + (1 + 1)).innerHTML = format(
        Decimal.pow(1.5, player.forkRepellentAmounts[1].minus( (1 == 0) ? 1 : 0 ))
        .times(10)
        .times(Decimal.pow(1.7, 1))
    , 3, 0);
    document.getElementById("FRDetails" + (1 + 1)).innerHTML = `<br>
        Amount: ${format(player.forkRepellentAmounts[1], 3, 0)}<br>
        Base prod: <span style="font-size: 13px;">+${format(
            Decimal.pow(1.1, player.forkRepellentAmounts[1])
            .div( (1 == 0) ? 1.1 : 1 )
            .times(player.forkRepellentAmounts[1])
            .times(getForkBoosts())
        , 3, 2)}<img src="images/fork.png" alt="Fork Image" width="15" height="15">/s</span>
    `;

    document.getElementById("ForksRequired" + (2 + 1)).innerHTML = format(
        Decimal.pow(1.5, player.forkRepellentAmounts[2].minus( (2 == 0) ? 2 : 0 ))
        .times(10)
        .times(Decimal.pow(1.7, 2))
    , 3, 0);
    document.getElementById("FRDetails" + (2 + 1)).innerHTML = `<br>
        Amount: ${format(player.forkRepellentAmounts[2], 3, 0)}<br>
        Base prod: <span style="font-size: 13px;">+${format(
            Decimal.pow(1.1, player.forkRepellentAmounts[2])
            .div( (2 == 0) ? 1.1 : 1 )
            .times(player.forkRepellentAmounts[2])
            .times(getForkBoosts())
        , 3, 2)}<img src="images/fork.png" alt="Fork Image" width="15" height="15">/s</span>
    `;
*/
    ...
    document.getElementById("EmpCakeEffect").innerHTML = format(getEmpoweredCakeEffect(), 3, 3)
    ...
    document.getElementById("JusticePointEffect1").innerHTML = format(getJusticePointEffects("Softcap-NKaU-2"), 3, 2)
    document.getElementById("JusticePointEffect2").innerHTML = format(getJusticePointEffects("KarmaPreExtReq"), 3, 2)
    ...
    document.getElementById("PrestigeRequirement1").innerHTML = format(temp.prestigeRequirements.amountRequired[0], 3, 0) + " Forks"
    document.getElementById("PrestigeRequirement2").innerHTML = format(temp.prestigeRequirements.amountRequired[1], 3, 0) + " Keys"
    document.getElementById("PrestigeRequirement3").innerHTML = format(temp.prestigeRequirements.amountRequired[2], 3, 0) + " Cakes"
    ...
    document.getElementById("TheJudgementUnlockRequirement").innerHTML = format(1e80, 3, 0) + " Karma"



    document.getElementById("AutomatorReq1").innerHTML = format(1000, 3, 0) + " Keys"
    document.getElementById("AutomatorReq2").innerHTML = format(3000, 3, 0) + " Cakes"
    document.getElementById("AutomatorReq3").innerHTML = format(10000, 3, 0) + " Cakes"
    document.getElementById("AutomatorReq4").innerHTML = format(50, 3, 0) + " Karma"
    document.getElementById("AutomatorReq5").innerHTML = format(2000, 3, 0) + " Karma"
    document.getElementById("AutomatorReq6").innerHTML = format("1e500", 3, 0) + " Karma"

    document.getElementById("AutomatorActivationStatement1").innerHTML = getCheckboxStatement(player.automator.autoFRs.isActive)
    document.getElementById("AutomatorActivationStatement2").innerHTML = getCheckboxStatement(player.automator.autoRNEUs.isActive)
    document.getElementById("AutomatorActivationStatement3").innerHTML = getCheckboxStatement(player.automator.autoNNEUs.isActive)
    document.getElementById("AutomatorActivationStatement4").innerHTML = getCheckboxStatement(player.automator.autoRCUs.isActive)
    document.getElementById("AutomatorActivationStatement5").innerHTML = getCheckboxStatement(player.automator.autoNCUs.isActive)
    document.getElementById("AutomatorActivationStatement6").innerHTML = getCheckboxStatement(player.automator.autoPreExt.isActive)

    document.getElementById("BackgroundAnimationCheckbox").innerHTML = getCheckboxStatement(player.options.backgroundAnimation)
    ...
    document.getElementById("AchRewardEffect10").innerHTML = format(getAchRewards("10"), 3, 3)
    document.getElementById("AchRewardEffect11").innerHTML = format(getAchRewards("11"), 3, 3)
    document.getElementById("AchRewardEffect12").innerHTML = format(getAchRewards("12"), 3, 2)
    document.getElementById("AchRewardEffect14").innerHTML = format(getAchRewards("14"), 3, 2)
    document.getElementById("AchRewardEffect16").innerHTML = format(getAchRewards("16"), 3, 3)
    document.getElementById("AchRewardEffect23").innerHTML = format(getAchRewards("23"), 3, 3)
    ...
    document.getElementById("AchRewardEffect46").innerHTML = format(getAchRewards("46"), 3, 1)
    ...
    document.getElementById("AchRewardEffect50").innerHTML = format(getAchRewards("50"), 3, 3)
    document.getElementById("AchRewardEffect52").innerHTML = format(getAchRewards("52"), 3, 1)
    document.getElementById("AchRewardEffect53").innerHTML = format(getAchRewards("53"), 3, 1)
    ...
    document.getElementById("RCUpgradeSoftcap4").innerHTML = (player.cakeUpgrades.repeatable.levels[3].gte(getRCUpgradeSoftcap("4")) ? " (softcapped)" : "")
    ...
    document.getElementById("NCUpgradeEffect4").innerHTML = format(getNCUpgradeEffect("4"), 3, 2)
    document.getElementById("NCUpgradeEffect5").innerHTML = format(getNCUpgradeEffect("5"), 3, 3)
    document.getElementById("NCUpgradeEffect6.1").innerHTML = format(getNCUpgradeEffect("6-Forks"), 3, 3)
    document.getElementById("NCUpgradeEffect6.2").innerHTML = format(getNCUpgradeEffect("6-Keys"), 3, 3)
    ...
    for (i = 0; i < 28; i++) {
        document.getElementById("NKaUpgradeCost" + (i + 1)).innerHTML = format(temp.karmaUpgrades.nonRepeatable.cost[i], 3, 0)
    }
    ...
    document.getElementById("NKaUpgradeEffect11").innerHTML = format(getNKaUpgradeEffect("11"), 3, 2)
    ...
    document.getElementById("NKaUpgradeEffect14").innerHTML = format(getNKaUpgradeEffect("14"), 3, 3)
    document.getElementById("NKaUpgradeEffect15").innerHTML = format(getNKaUpgradeEffect("15"), 3, 4)
    document.getElementById("NKaUpgradeEffect16.1").innerHTML = format(getNKaUpgradeEffect("16-JusticePoints"), 3, 3)
    document.getElementById("NKaUpgradeEffect16.2").innerHTML = format(getNKaUpgradeEffect("16-Karma"), 3, 3)
    document.getElementById("NKaUpgradeEffect17").innerHTML = format(getNKaUpgradeEffect("17"), 3, 4)
    document.getElementById("NKaUpgradeEffect18").innerHTML = format(getNKaUpgradeEffect("18"), 3, 4)
    document.getElementById("NKaUpgradeEffect19.1").innerHTML = format(getNKaUpgradeEffect("19-Karma"), 3, 3)
    document.getElementById("NKaUpgradeEffect19.2").innerHTML = format(getNKaUpgradeEffect("19-PreciousForks"), 3, 3)
    document.getElementById("NKaUpgradeEffect20").innerHTML = format(getNKaUpgradeEffect("20"), 3, 3)
    document.getElementById("NKaUpgradeEffect21").innerHTML = format(getNKaUpgradeEffect("21"), 3, 3)
    document.getElementById("NKaUpgradeEffect22").innerHTML = format(getNKaUpgradeEffect("22"), 3, 3)
    document.getElementById("NKaUpgradeEffect23").innerHTML = format(getNKaUpgradeEffect("23"), 3, 3)
    document.getElementById("NKaUpgradeEffect24").innerHTML = format(getNKaUpgradeEffect("24"), 3, 3)
    document.getElementById("NKaUpgradeEffect25").innerHTML = format(getNKaUpgradeEffect("25"), 3, 3)
    document.getElementById("NKaUpgradeEffect26").innerHTML = format(getNKaUpgradeEffect("26"), 3, 1)
    document.getElementById("NKaUpgradeEffect27.1").innerHTML = format(getNKaUpgradeEffect("27-NKaU-8"), 3, 3)
    document.getElementById("NKaUpgradeEffect27.2").innerHTML = format(getNKaUpgradeEffect("27-PFE-9"), 3, 3)
    document.getElementById("NKaUpgradeEffect28").innerHTML = format(getNKaUpgradeEffect("28"), 3, 3)

    document.getElementById("NKaUpgradeSoftcap2").innerHTML = (player.gainedKarma.gte(getNKaUpgradeSoftcap("2")) ? " (softcapped)" : "")
...
function updateStyle() {
    ...
    for (i = 0; i < temp.automatorsShown.length; i++) {
        if (temp.automatorsShown[i]) {
            document.getElementById("Automator" + (i + 1)).style.display = ""
        } else {
            document.getElementById("Automator" + (i + 1)).style.display = "none"
        }
    }
    ...
    {//Karma Upgrade stuff
        for (i = 0; i < 28; i++) {//Normal Karma Upgrades
    ...
    if (player.preciousForks.gte(temp.preciousExtension.preForkRequirement()) && player.karma.gte(temp.preciousExtension.karmaRequirement())) {
        document.getElementById("BuyPreExtButton").className = "preciousExtensionIsAffordable"
    } else {
        document.getElementById("BuyPreExtButton").className = "preciousExtensionIsNotAffordable"
    }

    if (player.karma.gte(temp.preciousExtension.karmaRequirement())) {
        document.getElementById("PreciousExtensionReq1").className = "preciousExtensionRequirementIsQualified"
    } else {
        document.getElementById("PreciousExtensionReq1").className = "preciousExtensionRequirementIsNotQualified"
    }

    if (player.preciousForks.gte(temp.preciousExtension.preForkRequirement())) {
        document.getElementById("PreciousExtensionReq2").className = "preciousExtensionRequirementIsQualified"
    } else {
        document.getElementById("PreciousExtensionReq2").className = "preciousExtensionRequirementIsNotQualified"
    }
    ...
    {//Automator Display
        ...
        if (player.automator.autoRCUs.isUnlocked) {
            document.getElementById("AutomatorText4").style.display = ""
            document.getElementById("AutomatorUnlock4").style.display = "none"
        } else {
            document.getElementById("AutomatorText4").style.display = "none"
            document.getElementById("AutomatorUnlock4").style.display = ""
        }

        if (player.automator.autoNCUs.isUnlocked) {
            document.getElementById("AutomatorText5").style.display = ""
            document.getElementById("AutomatorUnlock5").style.display = "none"
        } else {
            document.getElementById("AutomatorText5").style.display = "none"
            document.getElementById("AutomatorUnlock5").style.display = ""
        }

        if (player.automator.autoPreExt.isUnlocked) {
            document.getElementById("AutomatorText6").style.display = ""
            document.getElementById("AutomatorUnlock6").style.display = "none"
        } else {
            document.getElementById("AutomatorText6").style.display = "none"
            document.getElementById("AutomatorUnlock6").style.display = ""
        }
    }
    ...
    {//Achievement Reward Display
        ...
        if (player.achievementsGotten[9]) {
            document.getElementById("AchRewardDisplay10").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay10").style.display = "none"
        }

        if (player.achievementsGotten[10]) {
            document.getElementById("AchRewardDisplay11").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay11").style.display = "none"
        }
        ...
        if (player.achievementsGotten[13]) {
            document.getElementById("AchRewardDisplay14").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay14").style.display = "none"
        }
        ...
        if (player.achievementsGotten[22]) {
            document.getElementById("AchRewardDisplay23").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay23").style.display = "none"
        }
        ...
        if (player.achievementsGotten[45]) {
            document.getElementById("AchRewardDisplay46").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay46").style.display = "none"
        }
        ...
        if (player.achievementsGotten[49]) {
            document.getElementById("AchRewardDisplay50").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay50").style.display = "none"
        }

        if (player.achievementsGotten[51]) {
            document.getElementById("AchRewardDisplay52").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay52").style.display = "none"
        }

        if (player.achievementsGotten[52]) {
            document.getElementById("AchRewardDisplay53").style.display = ""
        } else {
            document.getElementById("AchRewardDisplay53").style.display = "none"
        }
    }
...
function hardReset() {
    player = new Player()
    save()
    executeLoadFunctions()
}

let currentVersion = "v1.1.0"
function versionCheck() {
    if (player.version == "v1.0.0" || player.version == "v1.0.1") {
...
function executeLoadFunctions() {
    ...
    document.getElementById("maxPrecInput").value = player.options.maxPrecision
    document.getElementById("maxPrecInputUnder1000").value = player.options.maxPrecisionUnder1000
    tab("BeforeLife")
