...
function getAchRewards(x) {
    switch (x+"") {
        case "2":
            ...
            .pow( (player.achievementsGotten[10]) ? getAchRewards("11") : new Decimal(1) )
        case "8":
            return new Decimal(2)
        case "9":
            return Decimal.log(player.repelledForks.plus(2), 2).root(2)
        case "10":
            return Decimal.log(player.keys.plus(2), 2)
        case "11":
            return Decimal.log(player.keys.plus(10), 10).root(2).times(3)
        case "12":
            ...
            let effPower = [
                function() {
                    return Decimal.log(Decimal.log(player.repelledForks.max("e7900").div("e7900").plus(10), 10).plus(10), 10).pow(1.25)
                },
            ...
            .pow(effPower[1]())
        case "14":
            return player.cakes.plus(1)
        case "16":
            return Decimal.log(Decimal.log(player.repelledForks.plus(10), 10).plus(9), 10)
        case "23":
        ...
        case "33":
            return Decimal.log(player.preciousForks.plus(10), 10).pow(2)
            .pow( Decimal.log(Decimal.log(player.preciousForks.plus(10), 10).plus(9), 10) )
        case "34":
            return Decimal.log(player.karma.plus(10), 10)
            .pow( Decimal.log(Decimal.log(player.karma.plus(10), 10).plus(9), 10).pow(1.5) )
        ...
        case "35.2": case "35-PreciousForks": case "35-PF"://To precious forks
            return Decimal.log(player.karma.plus(2), 2).root(2/1.5)
            .pow( (temp.preciousEffect.isUnlocked[11]) ? getPFEffects("12") : new Decimal(1) )
        ...
        case "38":
            return Decimal.log(player.preciousExtension.amount.plus(10), 10).root(5)
        //case "39" doesn't exist
        case "40":
            return ExpPower(player.empoweredCakes, 10, 1/2)
        case "46":
            return Decimal.log(player.karma.div("e200").plus(10), 10).pow(3)
        case "47":
...
function checkAchievements() {
    ...
    if (player.repelledForks.gte("1e123")) {
    ...
    if (player.repelledForks.gte(Decimal.pow(10, 8200))) {
    ...
    if (player.repelledForks.gte("e76000")) {
    ...
    if (player.karma.gte("6.666e666")) {
        giveAchievement(48)//49-1
    }

    if (player.karma.gte("e1000")) {
        giveAchievement(49)//50-1
    }

    if (player.karma.gte("e1500")) {
        giveAchievement(50)//51-1
    }

    if (player.karma.gte("e1914")) {
        giveAchievement(51)//52-1
    }

    if (player.karma.gte("e2250")) {
        giveAchievement(52)//53-1
    }
}
...
function changeAchThings(x) {
    switch (x+1) {
        ...
        case 2:
            ...
            achReward = "Reward: Boost Fork gain by x" + format(getAchRewards("2"), 3, 1)
            break;
        case 3:
        ...
        case 8:
            ...
            achReward = "Reward: 3rd NNEU Effect is raised ^" + format(getAchRewards("8"), 3, 1)
            break;
        case 9:
        ...
        case 10:
            ...
            achReward = "Reward: Keys boost fork gain"
            break;
        case 11:
            achTitle = "Are you full?"
            achDesc = "Have " + format(1e3, 3, 0) + " Cakes"
            achReward = "Reward: Keys power up Achievement 2 reward effect"
            break;
        case 12:
        ...
        case 14:
            ...
            achDesc = "Have " + format("1e123", 3, 0) + " Forks"
            achReward = "Reward: Cakes boost fork gain"
            break;
        case 15:
        ...
        case 23:
            ...
            achReward = "Reward: Empowered Cakes boost SW of all RNEUs"
            break;
        case 24:
        ...
        case 26:
            ...
            achReward = "Reward: Boost PFE strength by x" + format(getAchRewards("26"), 3, 2)
            break;
        case 27:
            achTitle = "AHHHHH!!! I CAN'T HOLD THIS ANYMORE!!!!"
            achDesc = "Have " + format(8, 3, 0) + " Precious Extensions"
            achReward = "Reward: Boost PFE strength by x" + format(getAchRewards("27"), 3, 2)
            break;
        case 28:
            achTitle = "*Explodes*"
            achDesc = "Have " + format(12, 3, 0) + " Precious Extensions"
            achReward = "Reward: Boost PFE strength by x" + format(getAchRewards("28"), 3, 2)
            break;
        case 29:
        ...
        case 38:
            ...
            achDesc = "Have " + format(Decimal.pow(10, 8200), 3, 0) + " Forks"
        ...
        case 39:
            ...
            break;
        case 40:
            achTitle = "Empowered Cake Duovigintillionaire"
        ...
        case 42:
            ...
            achDesc = "Have " + format(1e92, 3, 0) + " Karma"
            achReward = "<br>"
            break;
        case 43:
        ...
        case 45:
            achTitle = "LNGI Forks"
            achDesc = "Have " + format("e76000", 3, 0) + " Forks"
            achReward = "<br>"
            break;
        case 46:
            achTitle = "I've been waiting for new prestige layer..."
            achDesc = "Have " + format(1e200, 3, 0) + " Karma"
            achReward = "Reward: Karma boosts Precious Fork gain"
            break;
        case 47:
            ...
            break;
        case 48:
            achTitle = "^" + format(getNKaUpgradeEffect("17"), 3, 2) + " Precious Fork Effects =)"
            achDesc = "Buy 17th NKaU"
            achReward = "<br>"
            break;
        case 49:
            achTitle = "(ALMOST DIED)"
            achDesc = "Have " + format("6.666e666", 3, 0) + " Karma"
            achReward = "Reward: Forks boost SW of 2nd and 3rd RCU"
            break;
        case 50:
            achTitle = "Squared Tesseracted 1.25th powered googol karmas!"
            achDesc = "Have " + format("e1000", 3, 0) + " Karma"
            achReward = "Reward: Forks boost SW of 2nd, 3rd and 4th RKaU"
            break;
        case 51:
            achTitle = "Same as #50, but raised to 1.5"
            achDesc = "Have " + format("e1500", 3, 0) + " Karma"
            achReward = "<br>"
            break;
        case 52:
            achTitle = "10^World War I"
            achDesc = "Have " + format("e1914", 3, 0) + " Karma"
            achReward = "Reward: 9th PFE is raised ^" + format(getAchRewards("52"), 3, 1)
            break;
        case 53:
            achTitle = "Same as #50, but raised to 1.5 (2)"
            achDesc = "Have " + format("e2250", 3, 0) + " Karma"
            achReward = "Reward: Forks boost Precious Fork gain"
            break;
        default:
