...
function checkAchievements() {
    ...
    if (player.cakeUpgrades.repeatable.levels[3].gte(3e9)) {
...
function changeAchThings(x) {
    switch (x+1) {
        ...
        case 47:
            ...
            break;
        case 48:
            achTitle = "+" + format(getNKaUpgradeEffect("17").minus(1).times(100), 3, 2) + "% Precious Extensions =)"
            achDesc = "Buy 17th NKaU"
            achReward = "<br>"
            break;
        case 49:
            achTitle = "Not even big compared to 10{{{Forks}}}10"
            achDesc = "Have " + format(3e9, 3, 0) + " levels of 4th RCU"
            achReward = "<br>"
            break;
        default:
