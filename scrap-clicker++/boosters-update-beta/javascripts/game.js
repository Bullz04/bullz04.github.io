...
function updateText() {
    ...
    */
    ...
    document.getElementById("TrueBCCompletions7").innerHTML = format(getTrueBCCompletions(6).pow(1.25).times(3).max(1), 3, 3)
    document.getElementById("TrueBCCompletions8").innerHTML = format(player.brickUpgrades.repeatable.level[1].plus(1).pow(getTrueBCCompletions(7).max(1).times(3)), 3, 1)
