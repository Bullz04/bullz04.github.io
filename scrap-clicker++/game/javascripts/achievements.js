...
function getAchievementMultiplier() {
    return Decimal.pow(1.5, getTotalCompletedAchievements())
    .pow(
...
function changeAchThings(x) {
    switch (x+1) {
        ...
        case 19:
            ...
            achDesc = "Have over " + format(1e15) + " Protons and Electrons. Reward: Electron and proton gain are multiplied by " + format(5, 3, 2);
            break;
        case 20:
            achTitle = "Clay ≠ Scrap";
